...
SOUTH_AFRICA_DOSSIER = {
    ...
    "overview": {
        "summary": "L’Afrique du Sud est un État situé à l’extrémité australe du continent africain. Bordé par les océans Atlantique et Indien, il partage ses frontières avec la Namibie, le Botswana, le Zimbabwe, le Mozambique et l’Eswatini, et entoure entièrement le Lesotho. Son territoire réunit hauts plateaux, savanes, chaînes montagneuses, régions semi-arides, littoraux et écosystèmes d’une biodiversité remarquable. Pretoria, Le Cap et Bloemfontein exercent différentes fonctions de capitale, tandis que Johannesburg constitue le principal centre économique du pays. L’Afrique du Sud joue un rôle majeur dans les échanges, la diplomatie, la recherche, les arts et les institutions de l’Afrique australe. Son histoire humaine remonte à des périodes très anciennes et rassemble sociétés khoesan, communautés agricoles de langues bantoues, royaumes et chefferies, colonisations néerlandaise et britannique, esclavage au Cap, industrialisation minière, apartheid et transition vers une démocratie constitutionnelle à partir de 1994. Sa société contemporaine est profondément diverse par ses langues, ses religions, ses appartenances, ses territoires et ses mémoires. Ce dossier présente donc le pays dans son ensemble — géographie, population, institutions, économie, société, environnement et rôle régional — tout en approfondissant ses peuples, ses trajectoires historiques, ses figures, son patrimoine et ses cultures.",
