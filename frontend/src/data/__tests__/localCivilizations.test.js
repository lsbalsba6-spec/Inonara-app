...
describe("local civilization editorial corpus", () => {
  test("uses unique stable ids", () => {
    ...
    expect(ids).toEqual(expect.arrayContaining(["mali", "songhai", "kush", "axum", "great-zimbabwe", "kongo", "swahili", "benin", "egypt", "asante", "zulu", "hausa", "ghana-wagadu", "kanem-bornu", "ife", "oyo", "dahomey", "luba", "lunda", "buganda"]));
  });
