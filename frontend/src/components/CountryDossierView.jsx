...
const COPY = {
  en: {
    ...
    groups: [
      ...
      { id: "heritage", label: "Heritage & nature", items: [["heritage", "Heritage"], ["environment", "Nature & environment"]] },
  ...
  fr: {
    ...
    groups: [
      ...
      { id: "heritage", label: "Patrimoine & nature", items: [["heritage", "Patrimoine"], ["environment", "Nature & environnement"]] },
