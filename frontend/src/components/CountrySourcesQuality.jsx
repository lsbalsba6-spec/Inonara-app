...
const COPY = {
  en: {
    ...
    histIntro: "This section presents major interpretive debates and questions that remain open.",
  ...
  fr: {
    ...
    histIntro: "Cette section présente les principaux débats d’interprétation et les questions encore ouvertes.",
