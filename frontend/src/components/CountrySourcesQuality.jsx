...
const COPY = {
  en: {
    ...
    histTitle: "Debates, interpretations and open questions",
    histIntro: "This section presents major interpretive debates and questions that remain open without exposing internal editorial workflow labels.",
  ...
  fr: {
    ...
    histTitle: "Débats, interprétations et questions ouvertes",
    histIntro: "Cette section présente les principaux débats d’interprétation et les questions encore ouvertes sans exposer les libellés du workflow éditorial interne.",
